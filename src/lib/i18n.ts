...
const translations: Record<Language, TranslationKeys> = {
  fr: {
    ...
    home: {
      heroTitle: 'Votre librairie en ligne favorite',
      heroSubtitle: 'Découvrez des milliers de livres en français, arabe et anglais, livrés partout en Algérie',
      featuredBooks: 'Livres en vedette',
      browseCategories: 'Parcourir les catégories',
      printOnDemand: 'Livraison rapide',
      printOnDemandDesc: 'Recevez vos livres rapidement partout en Algérie',
      newArrivals: 'Nouveautés',
      bestSellers: 'Meilleures ventes',
      viewAll: 'Voir tout',
      exploreCatalog: 'Explorer le catalogue',
      whyKitabi: 'Pourquoi Kitabi ?',
      fastPrinting: 'Service rapide',
      fastPrintingDesc: 'Commandez et recevez vos livres en 3 à 5 jours ouvrables',
      qualityPrint: 'Qualité garantie',
      qualityPrintDesc: 'Des livres soigneusement sélectionnés avec une qualité professionnelle',
      ...
      step2: 'Ajoutez au panier',
      step2Desc: 'Sélectionnez les livres qui vous plaisent et passez votre commande facilement',
      ...
      step4Desc: 'Détendez-vous et savourez votre nouveau livre',
    },
    catalog: {
    ...
    book: {
      ...
      language: 'Langue',
      price: 'Prix',
      printDelay: 'Délai de livraison',
      addToCart: 'Ajouter au panier',
      printOnDemandNote: 'Délai de livraison estimé :',
  ...
  ar: {
    ...
    home: {
      heroTitle: 'مكتبتك الإلكترونية المفضلة',
      heroSubtitle: 'اكتشف آلاف الكتب بالفرنسية والعربية والإنجليزية، موصلة لكل ولايات الجزائر',
      featuredBooks: 'كتب مميزة',
      browseCategories: 'تصفح الفئات',
      printOnDemand: 'توصيل سريع',
      printOnDemandDesc: 'استلم كتبك بسرعة أينما كنت في الجزائر',
      newArrivals: 'وصل حديثاً',
      bestSellers: 'الأكثر مبيعاً',
      viewAll: 'عرض الكل',
      exploreCatalog: 'استكشف الكتالوج',
      whyKitabi: 'لماذا كتبي ؟',
      fastPrinting: 'خدمة سريعة',
      fastPrintingDesc: 'اطلب كتبك واستلمها في غضون 3 إلى 5 أيام عمل',
      qualityPrint: 'جودة مضمونة',
      qualityPrintDesc: 'كتب مختارة بعناية بجودة احترافية',
      ...
      step2: 'أضف إلى السلة',
      step2Desc: 'اختر الكتب التي تعجبك وأضفها إلى سلتك',
      step3: 'توصيل سريع',
      step3Desc: 'استلم طلبك مباشرة في منزلك أو في مكتب البريد',
      step4: 'استمتع بالقراءة',
      step4Desc: 'استرخِ واستمتع بكتابك الجديد',
    },
    catalog: {
      filterBy: 'تصفية حسب',
      sortBy: 'ترتيب حسب',
    ...
    book: {
      ...
      language: 'اللغة',
      price: 'السعر',
      printDelay: 'مدة التوصيل',
      addToCart: 'أضف إلى السلة',
      printOnDemandNote: 'مدة التوصيل المقدرة:',
      available: 'متوفر',
    ...
    footer: {
      about: 'عن كتبي',
      aboutDesc: 'كتبي هي مكتبتك الإلكترونية. نقدم تشكيلة واسعة من الكتب بالفرنسية والعربية والإنجليزية، موصلة إلى كل ولايات الجزائر.',
  ...
  en: {
    ...
    home: {
      heroTitle: 'Your Favorite Online Bookstore',
      heroSubtitle: 'Discover thousands of books in French, Arabic, and English, delivered across Algeria',
      featuredBooks: 'Featured Books',
      browseCategories: 'Browse Categories',
      printOnDemand: 'Fast Delivery',
      printOnDemandDesc: 'Receive your books quickly anywhere in Algeria',
      newArrivals: 'New Arrivals',
      bestSellers: 'Best Sellers',
      viewAll: 'View All',
      exploreCatalog: 'Explore Catalog',
      whyKitabi: 'Why Kitabi?',
      fastPrinting: 'Fast Service',
      fastPrintingDesc: 'Order your books and receive them within 3-5 business days',
      qualityPrint: 'Guaranteed Quality',
      qualityPrintDesc: 'Carefully selected books with professional quality',
      ...
      step2: 'Add to Cart',
      step2Desc: 'Select the books you like and add them to your cart',
      step3: 'Fast Delivery',
      step3Desc: 'Receive your order directly at your home or post office',
      step4: 'Enjoy Reading',
      step4Desc: 'Relax and enjoy your new book',
    },
    catalog: {
      filterBy: 'Filter By',
      sortBy: 'Sort By',
    ...
    book: {
      ...
      language: 'Language',
      price: 'Price',
      printDelay: 'Delivery Time',
      addToCart: 'Add to Cart',
      printOnDemandNote: 'Estimated delivery time:',
      available: 'Available',
